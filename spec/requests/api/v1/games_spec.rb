...
RSpec.describe '/api/v1/games', type: :request do
  ...
  describe 'POST /create' do
    context 'with valid parameters' do
      ...
      it 'renders a JSON response with the new game', :aggregate_failures do
        post api_v1_games_url,
             params: { game: valid_attributes }, headers: valid_headers, as: :json
    ...
    context 'with invalid parameters' do
      ...
      it 'renders a JSON response with errors for the new game', :aggregate_failures do
        post api_v1_games_url,
  ...
  describe 'PATCH /update' do
    context 'with valid parameters' do
      ...
      it 'renders a JSON response with the game', :aggregate_failures do
        game = Game.create! valid_attributes
        patch api_v1_game_url(game),
              params: { game: new_attributes }, headers: valid_headers, as: :json
    ...
    context 'with invalid parameters' do
      it 'renders a JSON response with errors for the game', :aggregate_failures do
        game = Game.create! valid_attributes
        patch api_v1_game_url(game),
              params: { game: invalid_attributes }, headers: valid_headers, as: :json
        expect(response).to have_http_status(:unprocessable_entity)
